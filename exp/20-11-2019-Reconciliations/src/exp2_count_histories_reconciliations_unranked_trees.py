    ...
    for k in TREES.keys():
        ...
        for i in range(0,nbTrees):
            ...
            for n in range(1,nMax+1):
                hS1,hH1,hD1,hT1 = fillMatricesHist(unrankedTree,n,MODEL={'D':True,'L':True,'T':False},X=1.0)
                nbHistories1 = int(hH1[unrankedTree.getID()][n],)
                hs1 += str(nbHistories1)+" "
                hS2,hH2,hD2,hT2 = fillMatricesHist(unrankedTree,n,MODEL={'D':True,'L':True,'T':True},X=1.0)
            ...
            for n in range(1,nMax+1):
                rS1,rH1,rD1,rT1 = fillMatricesRec(unrankedTree,n,MODEL={'D':True,'L':True,'T':False},X=1.0)
                nbReconciliations1 = int(rH1[unrankedTree.getID()][n],)
                rs1 += str(nbReconciliations1)+" "
                rS2,rH2,rD2,rT2 = fillMatricesRec(unrankedTree,n,MODEL={'D':True,'L':True,'T':True},X=1.0)
