...
if __name__ == "__main__":
    ...
    for j in range(0,nbt):
        ...
        S1,H1,D1,T1 = dpcount.fillMatrices(rkt,nMax,model1,1.0)
        nbHistories1 = H1[rkt.getID()][nMax]
        S2,H2,D2,T2 = dpcount.fillMatrices(rkt,nMax,model2,1.0)
        nbHistories2 = H2[rkt.getID()][nMax]
        S3,H3,D3,T3 = dpcount.fillMatrices(rkt,nMax,model3,1.0)
        ...
        if sample==1:
            for i in range(1,1000):
                h2 = dpcount.randGen(rkt,'H',2,S2,H2,D2,T2,model2)
                print("RLT\t"+str(h2))
            for i in range(1,1000):
                h3 = dpcount.randGen(rkt,'H',2,S3,H3,D3,T3,model3)
                print("RDL\t"+str(h3))
